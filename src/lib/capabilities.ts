...
// Single source of truth for the homepage "What we build" section — rendered by
// CapabilityTiles and emitted as Service JSON-LD by the homepage, so the
// structured data always matches the visible copy. Each capability has three
// subs in reading order: The Challenge, What We Offer, The Outcome.
